...
export const fetchOrders = createAsyncThunk("orders/fetchData", async (signedUser, { dispatch }) => {
    try {
...
export const handleOrder = createAsyncThunk("orders/create", async ({ signedUser, cartItems, total }) => {
    try {
